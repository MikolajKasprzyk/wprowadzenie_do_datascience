...
# %% exploring dataset
retail.info()
cols = [col for col in retail.columns] # lista z nazwami kolumn
retail.head() #wyswietla 5 pierwszysch weierszy
retail.tail() #wyswietla 5 ostatnich weierszy
...
# %%  dodatkowa kolumna z numerem dnia dt.day wyciaga nr dnia miesiaca z daty
